...
export const styles = {
  ...
  btn: {
    ...
    borderStyle: "solid",
    borderColor: "#bfdbfe",
    boxShadow: "inset -3px -3px 0 #1d4ed8, inset 3px 3px 0 #93c5fd, 0 0 16px 4px #38bdf8, 0 0 32px 8px #60a5fa",
    transition: "box-shadow 0.2s, filter 0.2s",
    filter: "drop-shadow(0 0 8px #60a5fa) drop-shadow(0 0 16px #38bdf8)",
  },
    menuOverlay: {
      background: "linear-gradient(180deg, #0f172a 80%, #2563eb 100%)",
